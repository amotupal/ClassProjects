...
if __name__ == '__main__':
    ...
    # This call should return a regressor object that is fully trained.
    r = regressor(data_train)
    params = r.get_params()    # This call should reaturn parameters of the model that are
    # fully trained.

    # Create a random testing dataset.
    data_test = dg.query_data(samples=20000)
    # This call should return predictions.
    predictions = r.get_predictions(data_test[0])

    print("Rmse error of predictions = " +
